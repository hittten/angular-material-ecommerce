...
function usingOperators() {
  ...
  // see https://rxjs.dev/operator-decision-tree
}
...
function asyncObservables() {
  ...
  // fromFetch('https://api.github.com/users/hittten')
  //   .pipe(
...
function subscriptions() {
  ...
  const subs2 = source$.subscribe(value => console.log(2, value))
